...
import * as examRoutes from '@/routes/exams';
...
const activeItemStyles =
    'text-foreground bg-accent/50 dark:bg-accent font-semibold';
...
export function AppHeader({ breadcrumbs = [] }: Props) {
    ...
    const mainNavItems: NavItem[] = isInstructor
        ? [
              ...
              {
                  title: t('dashboard.myExams'),
                  href: examRoutes.index(),
                  icon: BookOpen,
              },
              {
                  title: t('dashboard.createExam'),
                  href: examRoutes.create(),
                  icon: Folder,
              },
          ]
        : [
              ...
              },
              {
                  ...
                  href: studentRoutes.exams.index(),
                  icon: BookOpen,
              },
              {
                  title: t('student.results.title'),
                  href: studentRoutes.results(),
                  icon: Folder,
              },
          ];
    return (
                ...
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent
                                side="left"
                                className="flex h-full w-64 flex-col items-stretch justify-between bg-card"
                            >
                                        ...
                                        <div className="flex flex-col space-y-4">
                                            {mainNavItems.map((item) => (
                                                <Link
                                                    ...
                                                    href={item.href}
                                                    className={cn(
                                                        'flex items-center space-x-2 font-medium transition-colors hover:text-foreground/80',
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        <div className="relative flex items-center space-x-1">
                            ...
                            <LanguageSwitcher showLabel={false} size="icon" variant="ghost" />
                            <AppearanceSwitcher size="icon" variant="ghost" />
                        </div>
                        <DropdownMenu>
