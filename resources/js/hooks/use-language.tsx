...
const translations = {
    en: {
        ...
        'exams.questions.setup': 'Setup',
        'exams.questions.label_content': 'Content',
        'exams.questions.choices': 'Choices',
        'exams.questions.verification': 'Validation',
        'exams.questions.grading': 'Grading',
        'exams.points': 'points',
        ...
        // Exams - Assign Students
        'exams.assign.title': 'Manage Access',
        'exams.assign.description': 'Control which students are allowed to take',
        'exams.assign.tabs.directory': 'Student Directory',
        'exams.assign.tabs.bulk': 'Bulk Invite (Emails)',
        'exams.assign.bulk.title': 'Bulk Email Import',
        'exams.assign.bulk.description': 'Paste a list of student emails below',
        'exams.assign.bulk.notice': 'Enter emails separated by commas, spaces, or new lines. The system will automatically match them to existing student accounts and add them to the selection.',
        'exams.assign.bulk.label': 'Email List',
        'exams.assign.selected': 'Students to be assigned',
        'exams.assign.save': 'Save Assignments',
        ...
        'grading.review.violations.view_log': 'View Full Log',
        'grading.review.violations.sheet_title': 'Security Flags',
        'grading.review.violations.sheet_desc': 'Complete violation history for this attempt',
        'grading.review.violations.duration': 'away',
        'grading.review.violations.total_count': 'Total Count',
        'grading.review.violations.none': 'No violations recorded',
        'grading.review.violations.close': 'Close Log',
        'grading.review.violations.detected': 'Violations Detected',
        'grading.review.violations.notice': 'Review security flags and decide if a penalty is appropriate. Detailed violations can be viewed in the log.',
        'grading.review.time_taken': 'time taken',
        'grading.review.no_answer': 'NO ANSWER',
        'grading.review.reference': 'Reference',
        'grading.review.no_submission': 'No Submission',
        'grading.review.sidebar.score_control': 'SCORE CONTROL',
        'grading.review.score_preview': 'Live Score Preview',
        'grading.review.penalty_active': 'Penalty Active',
        'grading.review.real_time': 'Real-time update',
        'grading.review.disciplinary_penalty': 'Disciplinary Penalty',
        'grading.review.review_queue': 'Review Queue',
        'grading.review.no_review_needed': 'Perfect: No essay/text grading required',
        'grading.review.max_pts': 'MAX {0} PTS',
        'grading.review.grade_question': 'Grade Question #{0}',
        'grading.review.pending': 'Pending',
        'grading.review.instructor_reference': 'Instructor Reference',
        'grading.review.incomplete': 'Incomplete Submission',
        'grading.review.live_score': 'Live Score',
        'grading.review.assign_score': 'Assign Score',
        'grading.review.limit': 'Limit',
        ...
        'monitor.action.extend_all': 'Extend All Duration',
        'monitor.action.extend_all.prompt': 'Enter the number of minutes to add to ALL active exam sessions.',
    ...
    fr: {
        ...
        'exams.questions.points': 'Points',
        'exams.questions.setup': 'Configuration',
        'exams.questions.label_content': 'Contenu',
        'exams.questions.choices': 'Options',
        'exams.questions.verification': 'Validation',
        'exams.questions.grading': 'Notation',
        'exams.points': 'points',
        ...
        // Exams - Assign Students
        'exams.assign.title': 'Gérer l\'Accès',
        'exams.assign.description': 'Contrôlez quels étudiants sont autorisés à passer',
        'exams.assign.tabs.directory': 'Répertoire des étudiants',
        'exams.assign.tabs.bulk': 'Invitation en masse (E-mails)',
        'exams.assign.bulk.title': 'Importation d\'E-mails en masse',
        'exams.assign.bulk.description': 'Collez une liste d\'e-mails d\'étudiants ci-dessous',
        'exams.assign.bulk.notice': 'Saisissez les e-mails séparés par des virgules, des espaces ou des sauts de ligne. Le système les fera automatiquement correspondre aux comptes existants.',
        'exams.assign.bulk.label': 'Liste d\'e-mails',
        'exams.assign.selected': 'Étudiants à affecter',
        'exams.assign.save': 'Enregistrer les affectations',
        ...
        'exams.show.needs_review': 'À RÉVISER',
        ...
        'grading.review.violations.view_log': 'Voir le Journal',
        'grading.review.violations.sheet_title': 'Alertes de Sécurité',
        'grading.review.violations.sheet_desc': 'Historique complet des violations pour cette tentative',
        'grading.review.violations.duration': 'absent',
        'grading.review.violations.total_count': 'Compte Total',
        'grading.review.violations.none': 'Aucune violation enregistrée',
        'grading.review.violations.close': 'Fermer le Journal',
        'grading.review.violations.detected': 'Violations Détectées',
        'grading.review.violations.notice': 'Examinez les alertes de sécurité pour décider si une pénalité est appropriée. Les détails sont consultables dans le journal.',
        'grading.review.time_taken': 'temps pris',
        'grading.review.no_answer': 'PAS DE RÉPONSE',
        'grading.review.reference': 'Référence',
        'grading.review.no_submission': 'Aucune Soumission',
        'grading.review.sidebar.score_control': 'CONTRÔLE DU SCORE',
        'grading.review.score_preview': 'Aperçu du Score en Direct',
        'grading.review.penalty_active': 'Pénalité Active',
        'grading.review.real_time': 'Mise à jour en temps réel',
        'grading.review.disciplinary_penalty': 'Pénalité Disciplinaire',
        'grading.review.review_queue': 'File de Révision',
        'grading.review.no_review_needed': 'Parfait : aucune correction manuelle requise',
        'grading.review.max_pts': 'MAX {0} PTS',
        'grading.review.grade_question': 'Corriger la Question #{0}',
        'grading.review.pending': 'En attente',
        'grading.review.instructor_reference': 'Référence Instructeur',
        'grading.review.incomplete': 'Soumission Incomplète',
        'grading.review.live_score': 'Score en Direct',
        'grading.review.assign_score': 'Attribuer le Score',
        'grading.review.limit': 'Limite',
        ...
        'monitor.action.extend_all': 'Prolonger Toutes les Durées',
        'monitor.action.extend_all.prompt': 'Entrez le nombre de minutes à ajouter à TOUTES les sessions d\'examen actives.',
