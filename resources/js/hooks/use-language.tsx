...
const translations = {
    en: {
        ...
        'auth.confirmPassword.description': 'This is a secure area of the application. Please confirm your password before continuing.',
        'auth.confirmPassword.button': 'Confirm password',

        // Auth - Forgot Password
        'auth.forgotPassword.title': 'Forgot password',
        'auth.forgotPassword.description': 'Enter your email to receive a password reset link',
        'auth.forgotPassword.button': 'Email password reset link',
        'auth.forgotPassword.returnTo': 'Or, return to',

        // Auth - Reset Password
        'auth.resetPassword.title': 'Reset password',
        'auth.resetPassword.description': 'Please enter your new password below',
        ...
        'auth.twoFactor.recoveryDescription': 'Please confirm access to your account by entering one of your emergency recovery codes.',
        'auth.twoFactor.recoveryToggle': 'login using an authentication code',
        'auth.twoFactor.codeTitle': 'Authentication code',
        'auth.twoFactor.codeDescription': 'Enter the authentication code provided by your authenticator application.',
        'auth.twoFactor.codeToggle': 'login using a recovery code',
        ...
        'auth.verifyEmail.description': 'Please verify your email address by clicking on the link we just emailed to you.',
        'auth.verifyEmail.headTitle': 'Email verification',
        'auth.verifyEmail.sent': 'A new verification link has been sent to the email address you provided during registration.',
        'auth.verifyEmail.button': 'Resend verification email',
        ...
        'exams.questions.edit.description': 'Modify your question settings.',
        'exams.questions.new.description': 'Create a new question for your exam.',
        'exams.questions.true': 'True',
        'exams.questions.false': 'False',
        ...
        'exams.assign.bulk.placeholder': 'student1@example.com, student2@example.com...',
        'exams.assign.breadcrumb': 'Assign Students',
        ...
        'grading.violation.noAlerts': 'No alerts detected for this session',
        'grading.violation.standard_details': 'System capture: Standard focus breach detected.',
        'grading.action.review_penalize': 'Review & Penalize',
        ...
        'grading.review.penalty.evaluate': 'Evaluate disciplinary action for this student submission.',
        ...
        'student.results.yourScore': 'Your Score',
        'student.results.passed': 'Passed',
        'student.results.failed': 'Failed',
        'student.results.attemptSummary': 'Attempt Summary',
        'student.results.penaltyInfo': 'A penalty of {0} points was applied to this attempt.',
        'student.results.ofPoints': 'of {0} points',
        'student.results.passingScoreLabel': 'Passing Score',
        'student.results.minutesTaken': 'Minutes Taken',
        'student.results.questionReview': 'Question Review',
        'student.results.questionReviewDesc': 'Review your answers and see the correct solutions',
        'student.results.notAnswered': 'Not answered',
        'student.results.backToExams': 'Back to My Exams',
        'student.results.disciplinaryDeduction': 'Disciplinary Deduction',
        ...
        'settings.profile.infoDesc': 'Update your name and email address',
        ...
        'settings.password.info': 'Update Password',
        'settings.password.infoDesc': 'Ensure your account is using a long, random password to stay secure.',
        'settings.password.current': 'Current Password',
        'settings.password.new': 'New Password',
        'settings.password.confirm': 'Confirm Password',

        'settings.appearance.title': 'Appearance Settings',
        'settings.appearance.info': 'Appearance',
        'settings.appearance.infoDesc': 'Update your account\'s appearance settings',
        'settings.appearance.theme': 'Theme',
        'settings.appearance.themeDesc': 'Choose between light and dark mode',
        'settings.appearance.light': 'Light',
        'settings.appearance.dark': 'Dark',
        'settings.appearance.system': 'System',

        'settings.twoFactor.title': 'Two-Factor Authentication',
        'settings.twoFactor.info': 'Two-Factor Authentication',
        'settings.twoFactor.infoDesc': 'Manage your two-factor authentication settings',
        'settings.twoFactor.statusEnabled': 'Enabled',
        'settings.twoFactor.statusDisabled': 'Disabled',
        'settings.twoFactor.enabledDesc': 'With two-factor authentication enabled, you will be prompted for a secure pin during login, which you can retrieve from the TOTP-supported application on your phone.',
        'settings.twoFactor.disabledDesc': 'When you enable two-factor authentication, you will be prompted for a secure pin during login. This pin can be retrieved from a TOTP-supported application on your phone.',
        ...
        'settings.twoFactor.regenerate': 'Regenerate Recovery Codes',
        'settings.twoFactor.show': 'Show Recovery Codes',
        'settings.twoFactor.manualTitle': 'or, enter the code manually',
        'settings.twoFactor.back': 'Back',
        'settings.twoFactor.confirm': 'Confirm',
        'settings.twoFactor.modalEnabledTitle': 'Two-factor authentication enabled',
        'settings.twoFactor.modalEnabledDesc': 'Two-factor authentication is now enabled. Scan the QR code or enter the setup key in your authenticator app.',
        'settings.twoFactor.modalVerifyTitle': 'Verify authentication code',
        'settings.twoFactor.modalVerifyDesc': 'Enter the 6-digit code from your authenticator app',
        'settings.twoFactor.modalSetupTitle': 'Enable two-factor authentication',
        'settings.twoFactor.modalSetupDesc': 'To finish enabling two-factor authentication, scan the QR code or enter the setup key in your authenticator app',
        'settings.twoFactor.close': 'Close',
        'settings.twoFactor.continue': 'Continue',
        'settings.twoFactor.recoveryTitle': '2FA Recovery Codes',
        'settings.twoFactor.recoveryDesc': 'Recovery codes let you regain access if you lose your 2FA device. Store them in a secure password manager.',
        'settings.twoFactor.viewCodes': 'View',
        'settings.twoFactor.hideCodes': 'Hide',
        'settings.twoFactor.recoverySuffix': ' recovery codes',
        'settings.twoFactor.regenerateCodes': 'Regenerate codes',
        'settings.twoFactor.recoveryWarning': 'Each recovery code can be used once to access your account and will be removed after use. If you need more, click Regenerate codes above.',
        'settings.twoFactor.setup': 'When two-factor authentication is enabled, you will be prompted for a secure, random token during authentication. You may retrieve this token from your phone\'s Google Authenticator application.',
        'settings.twoFactor.confirmSetup': 'To finish enabling two-factor authentication, scan the following QR code using your phone\'s authenticator application or enter the setup key and provide the generated OTP code.',
        'settings.twoFactor.store': 'Store these recovery codes in a secure password manager. They can be used to recover access to your account if your two-factor authentication device is lost.',
        'settings.twoFactor.confirmTitle': 'Confirm Password to Continue',
        'settings.twoFactor.confirmDesc': 'For your security, please confirm your password to continue.',
        'settings.twoFactor.done': 'Done',
        'student.grade.penalty': 'Penalty',
        'student.grade.notProvided': 'Not provided',
        'student.grade.detectedBreaches': 'Detected breaches',
        'student.grade.noSelection': 'No selection',
        'student.grade.noResponse': 'No response provided',
        ...
        'exam.take.submitting.desc': 'Please wait while your answers are securely saved...',
        'exam.take.enteringMode': 'Entering Fullscreen Mode',
        'exam.take.paused.title': 'Exam Paused',
        'exam.take.paused.desc': 'The instructor has temporarily paused your exam session. Please wait for further instructions.',
        'exam.take.paused.awaiting': 'Awaiting Instructor Signal...',
        'exam.take.securityImminent': 'Security Submission Imminent',
        'exam.take.errorSaving': 'Error saving',
        'exam.take.securityWarning': 'Security Warning!',
        'exam.take.securityAttempts': 'Attempts: {0}/{1}',
        'exam.take.fromInstructor': 'From Instructor: {0}',
        'exam.take.resumed.title': 'Exam Resumed',
        'exam.take.resumed.desc': 'The instructor has resumed your exam session.',
        ...
        'monitor.toast.reset_success': 'Attempt reset successfully',
        'monitor.toast.delete_success': 'Attempt deleted permanently',
        'monitor.toast.clear_violations_success': 'Violations cleared',
        'monitor.toast.force_submit_success': 'Exam forced hand-in',
        'monitor.toast.extend_single_success': 'Extended by {0} minutes',
        'monitor.toast.extend_all_success': 'Extended time for all by {0} minutes',
        'monitor.session_management': 'Session Management',
        'monitor.security_alerts': 'Security Alerts',
        'monitor.more_incidents': '+ {0} more incidents',
        'monitor.noActive.desc': 'Monitoring is currently active. Any new student join will trigger an instant update.',
        'monitor.secure_perimeter': 'System perimeter secure.',
        'monitor.all_regular': 'All Regular',
        'monitor.table.student': 'Student',
        'monitor.table.status': 'Status',
        'monitor.table.completion': 'Completion',
        'monitor.table.security': 'Security',
        'monitor.table.started_at': 'Started At',
    ...
    fr: {
        ...
        // Auth - Confirm Password
        'auth.confirmPassword.title': 'Confirmez votre mot de passe',
        'auth.confirmPassword.description': 'Ceci est une zone sécurisée de l\'application. Veuillez confirmer votre mot de passe avant de continuer.',
        'auth.confirmPassword.button': 'Confirmer le mot de passe',

        // Auth - Forgot Password
        'auth.forgotPassword.title': 'Mot de passe oublié',
        'auth.forgotPassword.description': 'Entrez votre email pour recevoir un lien de réinitialisation de mot de passe',
        'auth.forgotPassword.button': 'Envoyer le lien de réinitialisation',
        'auth.forgotPassword.returnTo': 'Ou, retourner à la page de',

        // Auth - Reset Password
        'auth.resetPassword.title': 'Réinitialiser le mot de passe',
        'auth.resetPassword.description': 'Veuillez entrer votre nouveau mot de passe ci-dessous',
        ...
        'auth.twoFactor.recoveryDescription': 'Veuillez confirmer l\'accès à votre compte en entrant l\'un de vos codes de récupération d\'urgence.',
        'auth.twoFactor.recoveryToggle': 'se connecter en utilisant un code d\'authentification',
        'auth.twoFactor.codeTitle': 'Code d\'authentification',
        'auth.twoFactor.codeDescription': 'Entrez le code d\'authentification fourni par votre application d\'authentification.',
        'auth.twoFactor.codeToggle': 'se connecter en utilisant un code de récupération',
        'auth.twoFactor.recoveryPlaceholder': 'Entrez le code de récupération',
        'auth.twoFactor.orYouCan': 'ou vous pouvez ',

        // Auth - Verify Email
        'auth.verifyEmail.title': 'Vérifier l\'e-mail',
        'auth.verifyEmail.description': 'Veuillez vérifier votre adresse e-mail en cliquant sur le lien que nous venons de vous envoyer par e-mail.',
        'auth.verifyEmail.headTitle': 'Vérification de l\'e-mail',
        'auth.verifyEmail.sent': 'Un nouveau lien de vérification a été envoyé à l\'adresse e-mail que vous avez fournie lors de l\'inscription.',
        'auth.verifyEmail.button': 'Renvoyer l\'e-mail de vérification',
        ...
        'exams.questions.edit.description': 'Modifier les paramètres de votre question.',
        'exams.questions.new.description': 'Créer une nouvelle question pour votre examen.',
        'exams.questions.true': 'Vrai',
        'exams.questions.false': 'Faux',
        'exams.questions.points': 'Points',
        ...
        'exams.assign.bulk.placeholder': 'etudiant1@exemple.com, etudiant2@exemple.com...',
        'exams.assign.breadcrumb': 'Assigner des étudiants',
        ...
        'grading.violation.noAlerts': 'Aucune alerte détectée pour cette session',
        'grading.violation.standard_details': 'Capture système : Brèche de concentration standard détectée.',
        'grading.action.review_penalize': 'Vérifier et pénaliser',
        ...
        'grading.review.penalty.evaluate': 'Évaluer l’action disciplinaire pour cette soumission d’étudiant.',
        ...
        'student.results.yourScore': 'Votre Note',
        'student.results.passed': 'Réussi',
        'student.results.failed': 'Échoué',
        'student.results.attemptSummary': 'Résumé de la Tentative',
        'student.results.penaltyInfo': 'Une pénalité de {0} points a été appliquée à cette tentative.',
        'student.results.ofPoints': 'sur {0} points',
        'student.results.passingScoreLabel': 'Note de Passage',
        'student.results.minutesTaken': 'Minutes Prises',
        'student.results.questionReview': 'Révision des Questions',
        'student.results.questionReviewDesc': 'Examinez vos réponses et voyez les solutions correctes',
        'student.results.notAnswered': 'Pas de réponse',
        'student.results.backToExams': 'Retour à Mes Examens',
        'student.results.disciplinaryDeduction': 'Déduction Disciplinaire',
        ...
        'settings.profile.infoDesc': 'Mettez à jour votre nom et votre adresse e-mail',
        ...
        'settings.profile.verificationSent': 'Un nouveau lien de vérification a été envoyé à votre adresse e-mail.',
        'settings.profile.saved': 'Enregistré',

        'settings.password.title': 'Paramètres du Mot de Passe',
        'settings.password.info': 'Mettre à jour le Mot de Passe',
        'settings.password.infoDesc': 'Assurez-vous que votre compte utilise un mot de passe long et aléatoire pour rester en sécurité.',
        ...
        'settings.appearance.info': 'Apparence',
        'settings.appearance.infoDesc': 'Mettez à jour les paramètres d\'apparence de votre compte',
        'settings.appearance.theme': 'Thème',
        'settings.appearance.themeDesc': 'Choisissez entre le mode clair et sombre',
        'settings.appearance.light': 'Clair',
        'settings.appearance.dark': 'Sombre',
        'settings.appearance.system': 'Système',

        'settings.twoFactor.title': 'Authentification à Deux Facteurs',
        'settings.twoFactor.info': 'Authentification à Deux Facteurs',
        'settings.twoFactor.infoDesc': 'Gérez vos paramètres d\'authentification à deux facteurs',
        'settings.twoFactor.statusEnabled': 'Activé',
        'settings.twoFactor.statusDisabled': 'Désactivé',
        'settings.twoFactor.enabledDesc': 'L\'authentification à deux facteurs étant activée, un code PIN sécurisé vous sera demandé lors de la connexion, que vous pourrez récupérer à partir de l\'application compatible TOTP de votre téléphone.',
        'settings.twoFactor.disabledDesc': 'Lorsque vous activez l\'authentification à deux facteurs, un code PIN sécurisé vous sera demandé lors de la connexion. Ce code PIN peut être récupéré à partir d\'une application compatible TOTP sur votre téléphone.',
        'settings.twoFactor.continueSetup': 'Continuer la Configuration',
        'settings.twoFactor.enable': 'Activer la 2FA',
        'settings.twoFactor.disable': 'Désactiver la 2FA',
        'settings.twoFactor.regenerate': 'Régénérer les Codes de Récupération',
        'settings.twoFactor.show': 'Afficher les Codes de Récupération',
        'settings.twoFactor.manualTitle': 'ou, saisissez le code manuellement',
        'settings.twoFactor.back': 'Retour',
        'settings.twoFactor.confirm': 'Confirmer',
        'settings.twoFactor.modalEnabledTitle': 'Authentification à deux facteurs activée',
        'settings.twoFactor.modalEnabledDesc': 'L\'authentification à deux facteurs est maintenant activée. Scannez le code QR ou saisissez la clé de configuration dans votre application d\'authentification.',
        'settings.twoFactor.modalVerifyTitle': 'Vérifier le code d\'authentification',
        'settings.twoFactor.modalVerifyDesc': 'Saisissez le code à 6 chiffres de votre application d\'authentification',
        'settings.twoFactor.modalSetupTitle': 'Activer l\'authentification à deux facteurs',
        'settings.twoFactor.modalSetupDesc': 'Pour terminer l\'activation de l\'authentification à deux facteurs, scannez le code QR ou saisissez la clé de configuration dans votre application d\'authentification',
        'settings.twoFactor.close': 'Fermer',
        'settings.twoFactor.continue': 'Continuer',
        'settings.twoFactor.recoveryTitle': 'Codes de Récupération 2FA',
        'settings.twoFactor.recoveryDesc': 'Les codes de récupération vous permettent de retrouver l\'accès si vous perdez votre appareil 2FA. Conservez-les dans un gestionnaire de mots de passe sécurisé.',
        'settings.twoFactor.viewCodes': 'Afficher',
        'settings.twoFactor.hideCodes': 'Masquer',
        'settings.twoFactor.recoverySuffix': ' les codes de récupération',
        'settings.twoFactor.regenerateCodes': 'Régénérer les codes',
        'settings.twoFactor.recoveryWarning': 'Chaque code de récupération peut être utilisé une fois pour accéder à votre compte et sera supprimé après utilisation. Si vous en avez besoin de plus, cliquez sur Régénérer les codes ci-dessus.',
        'settings.twoFactor.setup': 'Lorsque l\'authentification à deux facteurs est activée, un jeton sécurisé et aléatoire vous sera demandé lors de l\'authentification. Vous pouvez récupérer ce jeton à partir de l\'application Google Authenticator de votre téléphone.',
        'settings.twoFactor.confirmSetup': 'Pour terminer l\'activation de l\'authentification à deux facteurs, scannez le code QR suivant à l\'aide de l\'application d\'authentification de votre téléphone ou saisissez la clé de configuration et fournissez le code OTP généré.',
        'settings.twoFactor.store': 'Conservez ces codes de récupération dans un gestionnaire de mots de passe sécurisé. Ils peuvent être utilisés pour récupérer l\'accès à votre compte si votre appareil d\'authentification à deux facteurs est perdu.',
        'settings.twoFactor.confirmTitle': 'Confirmer le Mot de Passe pour Continuer',
        'settings.twoFactor.confirmDesc': 'Pour votre sécurité, veuillez confirmer votre mot de passe pour continuer.',
        'settings.twoFactor.done': 'Terminé',
        'student.grade.penalty': 'Pénalité',
        'student.grade.notProvided': 'Non fourni',
        'student.grade.detectedBreaches': 'Brèches détectées',
        'student.grade.noSelection': 'Aucune sélection',
        'student.grade.noResponse': 'Aucune réponse fournie',
        ...
        'exam.take.submitting.desc': 'Veuillez patienter pendant que vos réponses sont enregistrées en toute sécurité...',
        'exam.take.enteringMode': 'Entrée en mode plein écran',
        'exam.take.paused.title': 'Examen mis en pause',
        'exam.take.paused.desc': "L'instructeur a temporairement mis votre session d'examen en pause. Veuillez attendre d'autres instructions.",
        'exam.take.paused.awaiting': "En attente du signal de l'instructeur...",
        'exam.take.securityImminent': 'Soumission de sécurité imminente',
        'exam.take.errorSaving': "Erreur lors de l'enregistrement",
        'exam.take.securityWarning': 'Avertissement de sécurité !',
        'exam.take.securityAttempts': 'Tentatives: {0}/{1}',
        'exam.take.fromInstructor': "De l'instructeur: {0}",
        'exam.take.resumed.title': 'Examen repris',
        'exam.take.resumed.desc': "L'instructeur a repris votre session d'examen.",
        ...
        'monitor.toast.reset_success': 'Tentative réinitialisée avec succès',
        'monitor.toast.delete_success': 'Tentative supprimée définitivement',
        'monitor.toast.clear_violations_success': 'Violations effacées',
        'monitor.toast.force_submit_success': 'Examen forcé à la remise',
        'monitor.toast.extend_single_success': 'Prolongé de {0} minutes',
        'monitor.toast.extend_all_success': 'Temps prolongé pour tous de {0} minutes',
        'monitor.session_management': 'Gestion de Session',
        'monitor.security_alerts': 'Alertes de Sécurité',
        'monitor.more_incidents': '+ {0} autres incidents',
        'monitor.noActive.desc': 'La surveillance est actuellement active. Toute nouvelle participation d\'un étudiant déclenchera une mise à jour instantanée.',
        'monitor.secure_perimeter': 'Périmètre du système sécurisé.',
        'monitor.all_regular': 'Tout Régulier',
        'monitor.table.student': 'Étudiant',
        'monitor.table.status': 'Statut',
        'monitor.table.completion': 'Complétion',
        'monitor.table.security': 'Sécurité',
        'monitor.table.started_at': 'Commencé à',
        'monitor.table.actions': 'Actions',
